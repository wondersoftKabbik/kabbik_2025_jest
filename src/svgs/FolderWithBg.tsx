...
const FolderWithBgIcon = () => {
  return (
    <>
        ...
        <feBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_18_657"/>
...
export default FolderWithBgIcon