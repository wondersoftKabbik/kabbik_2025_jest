...
const One = () => {
  return (
    <span className=''>
       <svg className='h-[83%] w-[60%]  md:h-[94%] md:w-[80%]'    viewBox="0 0 138 309" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M4 52V108L75 65V306H132.5V2.5H81.5L4 52Z" fill="black" stroke="black"/>
