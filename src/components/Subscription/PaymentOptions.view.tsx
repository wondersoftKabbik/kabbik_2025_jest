...
const PaymentOptions = ({
  ...
  return (
    <>
      ...
      <div className={findAtLeastOne('mobile_balance')?"px-4 border-t-[1px] border-muted2 mt-10":'hidden'}>
        <div className="flex flex-col lg:flex-row mx-2 lg:items-center lg:justify-between mb-5">
          <div className="mb-6 lg:mb-0 mt-4">
      ...
      <div className={findAtLeastOne('card')?"px-4 border-t-[1px] border-muted2 mt-10":'hidden'}>
        <div className="flex flex-col lg:flex-row mx-2 lg:items-center lg:justify-between mb-5">
          <div className="mb-6 lg:mb-0 mt-4">
